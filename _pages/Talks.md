...
<p class="page__meta"><i class="far fa-calendar-alt" aria-hidden="true"></i> {{ "2018-03-08" | date: '%B %d, %Y' }}</p> <p class="page__meta"><i class="fas fa-map-marked-alt"></i> Los Angeles, CA, USA</p>
